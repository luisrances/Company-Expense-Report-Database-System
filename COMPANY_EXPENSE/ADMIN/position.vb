...
Public Class position
    ...
    Public Sub LoadRecords(command As String, dgv As DataGridView)
        ...
        ComboBox1.DisplayMember = "pos_id"
        ComboBox1.ValueMember = "pos_id"
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        'audit trail
        Dim table_name As String = "position"
        Dim id As String = ComboBox1.Text
        Dim oldValue As String = audit_trail.GetOldValue(table_name, "pos_id", id)
        Dim newValue As String = "pos_name : " & textbox2.Text
        ...
        If to_add Then
            Try
                ...
                End If
                con.Open()
                sql = "insert into position values('" & ComboBox1.Text & "','" & textbox2.Text & "');"
                cmd.Connection = con
                cmd.CommandText = sql
                cmd.ExecuteNonQuery()
                con.Close()
        ...
        ElseIf to_edit Then
            Try
                ...
                End If
                con.Open()
                sql = "UPDATE position SET pos_name = '" & textbox2.Text &
        ...
        ElseIf to_delete Then
            ...
            If result = DialogResult.OK Then
                ...
                Try
                    con.Open()
                    sql = "delete from position where pos_id = " & ComboBox1.Text & ";"
                    cmd.Connection = con
                    cmd.CommandText = sql
                    cmd.ExecuteNonQuery()
                    con.Close()
        ...
        ElseIf to_search Then
            Try
                ...
                End If
                con.Open()
                sql = "SELECT * FROM position WHERE pos_id LIKE '%" & txtSearch.Text &
