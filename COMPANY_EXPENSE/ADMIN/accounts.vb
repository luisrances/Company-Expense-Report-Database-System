...
Public Class accounts
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        'audit trail
        Dim table_name As String = "accounts"
        Dim id As String = ComboBox1.Text
        Dim oldValue As String = audit_trail.GetOldValue(table_name, "id", id)
        Dim newValue As String = "email : " & textbox2.Text &
                        ", pass : " & textbox3.Text &
                        ", employee_id : " & ComboBox2.SelectedValue
        ...
        If to_add Then
            Try
                If textbox2.TextLength = 0 Or textbox3.TextLength = 0 Then
                    Throw New Exception
                End If
                con.Open()
                sql = "insert into accounts values('" & ComboBox1.Text & "','" & textbox2.Text &
        ...
        ElseIf to_edit Then
            Try
                ...
                End If
                con.Open()
                sql = "UPDATE accounts SET email = '" & textbox2.Text &
                                "', pass = '" & textbox3.Text &
                                "', employee_id = '" & ComboBox2.SelectedValue &
        ...
        ElseIf to_delete Then
            ...
            If result = DialogResult.OK Then
                ...
                Try
                    con.Open()
                    sql = "delete from accounts where id = " & ComboBox1.SelectedValue & ";"
                    cmd.Connection = con
                    cmd.CommandText = sql
                    cmd.ExecuteNonQuery()
                    con.Close()
        ...
        ElseIf to_search Then
            Try
                ...
                End If
                con.Open()
                sql = "SELECT * FROM accounts WHERE id LIKE '%" & txtSearch.Text &
                    "%' OR email LIKE '%" & txtSearch.Text &
                    "%' OR pass LIKE '%" & txtSearch.Text &
