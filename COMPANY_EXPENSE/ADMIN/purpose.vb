...
Public Class purpose
    ...
    'Dim cmd As New MySqlCommand
    'Dim da As New MySqlDataAdapter
    Private Sub purpose_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        all = "SELECT * from purpose"
    ...
    Public Sub LoadRecords(command As String, dgv As DataGridView)
        ...
        ComboBox1.DisplayMember = "purpose_id"
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        'audit trail
        Dim table_name As String = "purpose"
        Dim id As String = ComboBox1.Text
        Dim oldValue As String = audit_trail.GetOldValue(table_name, "purpose_id", id)
        Dim newValue As String = "purpose_description : " & textbox2.Text
        ...
        If to_add Then
            Try
                ...
                End If
                con.Open()
                sql = "insert into purpose values('" & ComboBox1.Text & "','" & textbox2.Text & "');"
                cmd.Connection = con
                cmd.CommandText = sql
                cmd.ExecuteNonQuery()
                con.Close()
        ...
        ElseIf to_edit Then
            Try
                ...
                End If
                con.Open()
                sql = "UPDATE purpose SET purpose_description = '" & textbox2.Text &
                               "' WHERE purpose_id = " & ComboBox1.Text & ";"
                cmd.Connection = con
                cmd.CommandText = sql
                cmd.ExecuteNonQuery()
                con.Close()
        ...
        ElseIf to_delete Then
            ...
            If result = DialogResult.OK Then
                ...
                Try
                    con.Open()
                    sql = "delete from purpose where purpose_id = " & ComboBox1.Text & ";"
                    cmd.Connection = con
                    cmd.CommandText = sql
                    cmd.ExecuteNonQuery()
                    con.Close()
        ...
        ElseIf to_search Then
            Try
                ...
                End If
                con.Open()
                sql = "SELECT * FROM purpose WHERE purpose_id LIKE '%" & txtSearch.Text &
                    "%' OR purpose_description LIKE '%" & txtSearch.Text & "%';"
