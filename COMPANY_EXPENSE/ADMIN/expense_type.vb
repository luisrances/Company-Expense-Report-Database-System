...
Public Class expense_type
    ...
    'Dim cmd As New MySqlCommand
    'Dim da As New MySqlDataAdapter
    Private Sub expense_type_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        all = "SELECT * from expense_type"
    ...
    Public Sub LoadRecords(command As String, dgv As DataGridView)
        ...
        'for expense_type_id combobox
        con.Open()
        dt = New DataTable
        da = New MySqlDataAdapter("select * from expense_type", con)
        da.Fill(dt)
        ComboBox1.DataSource = dt
        ComboBox1.DisplayMember = "EXP_TYPE_ID"
        ComboBox1.ValueMember = "EXP_TYPE_ID"
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        'audit trail
        Dim table_name As String = "expense_type"
        Dim id As String = ComboBox1.Text
        Dim oldValue As String = audit_trail.GetOldValue(table_name, "exp_type_id", id)
        Dim newValue As String = "exp_type_name : " & textbox2.Text
        ...
        If to_add Then
            ...
            Try
                If textbox2.TextLength = 0 Then
                    Throw New Exception
                End If
                sql = "insert into expense_type values('" & ComboBox1.Text & "','" & textbox2.Text & "');"
                cmd.Connection = con
                cmd.CommandText = sql
                cmd.ExecuteNonQuery()
                con.Close()
        ...
        ElseIf to_edit Then
            Try
                ...
                End If
                con.Open()
                sql = "UPDATE expense_type SET exp_type_name = '" & textbox2.Text &
                    "' WHERE exp_type_id = " & ComboBox1.Text & ";"
                cmd.Connection = con
                cmd.CommandText = sql
                cmd.ExecuteNonQuery()
                con.Close()
        ...
        ElseIf to_delete Then
            ...
            If result = DialogResult.OK Then
                ...
                Try
                    con.Open()
                    sql = "delete from expense_type where exp_type_id = " & ComboBox1.Text & ";"
                    cmd.Connection = con
                    cmd.CommandText = sql
                    cmd.ExecuteNonQuery()
                    con.Close()
        ...
        ElseIf to_search Then
            Try
                ...
                End If
                con.Open()
                sql = "SELECT * FROM expense_type WHERE exp_type_id LIKE '%" & txtSearch.Text &
